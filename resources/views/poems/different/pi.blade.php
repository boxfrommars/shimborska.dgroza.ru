...
@section('content')
    ...
    <div class="poem">
        <p>
            ...
            не удержать на краешке страницы;<br/>
            она сползает дальше по столу, уходит в воздух,<br/>
            ...
            окружность бедер два пальца шарада и шифр,<br/>
            а в нем соловушка, лети и пой,<br/>
    ...
    <div class="poem" lang="pl">
        ...
        <p>
            ...
            nie zatrzymuje się na brzegu kartki,<br/>
            potrafi ciągnąć się po stole, przez powietrze,<br/>
            ...
            obwód w biodrach dwa palce szarada i szyfr,<br/>
            w którym słowiczku mój a leć, a piej<br/>

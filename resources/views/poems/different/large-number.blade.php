...
@section('content')
    ...
    <div class="poem">
        <p>
            Четыре миллиарда населенья,<br/>
            мое ж воображение, как прежде.<br/>
            С большими числами не ведает, как быть.<br/>
        ...
        <p>
            Дом опустел и обрастает флигельками эха.<br/>
            С порога я в долину выбегаю,<br/>
    ...
    <div class="poem" lang="pl">
        <h3>Wielka liczba</h3>
        <p>
            Cztery miliardy ludzi na tej ziemi,<br/>
            a moja wyobraźnia jest jak była.<br/>
            Źle sobie radzi z wielkimi liczbami.<br/>
            Ciągle ją jeszcze wzrusza poszczególność.<br/>
            Fruwa w ciemnościach jak światło latarki,<br/>
            wyjawia tylko pierwsze z brzegu twarze,<br/>
            tymczasem reszta w prześlepienie idzie,<br/>
            w niepomyślenie, w nieodżałowanie.<br/>
            Ale tego sam Dante nie zatrzymałby.<br/>
            A cóż dopiero kiedy nie jest się.<br/>
        ...
        <p>
            Obrasta pusty dom przybudówkami echa.<br/>
            Zbiegam z progu w dolinę<br/>

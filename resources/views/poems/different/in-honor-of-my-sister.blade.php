...
@section('content')
    ...
    <div class="poem" lang="pl">
        <h3>Pochwała siostry</h3>
        <p>
            Moja siostra nie pisze wierszy<br/>
            i chyba już nie zacznie nagle pisać wierszy.<br/>
            Ma to po matce, która nie pisała wierszy,<br/>
            oraz po ojcu, który też nie pisał wierszy.<br/>
    ...
    <div class="poem">
        ...
        <p>
            ...
            Она в мать, которая не писала стихов,<br/>
            и в отца, который тоже не писал стихов.<br/>
            Под кровом моей сестры я ощущаю себя в безопасности:<br/>
            муж моей сестры ни за что на свете не стал бы писать стихов.<br/>
            И хотя это выглядит как произведение Александра Мацедонского,<br/>
